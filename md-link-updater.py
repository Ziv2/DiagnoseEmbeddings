...
def main():
    # Get input from user
    # input_file = input("Enter the path to your markdown file: ").strip()
    # github_url = input("Enter your GitHub repository URL (e.g., https://github.com/username/repo/blob/main): ").strip()
    
    base_folder = input("/home/z/Documents/DK_2025/Literature_Review")
    github_url = input("https://github.com/Ziv2/EmbeddingDiagnostics.git")
    # input_file = input("https://github.com/Ziv2/EmbeddingDiagnostics/blob/master/master.md")
    input_file = input("/home/z/Documents/DK_2025/Literature_Review/master.md")
